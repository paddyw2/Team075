...
blackPiece = 'img/black.gif'
wn.addshape(blackPiece)
piece = tt.Turtle()
piece.shape(blackPiece)
piece.pu()

whitePiece = 'img/white.gif'
wn.addshape(whitePiece)
pieceW = tt.Turtle()
pieceW.shape(whitePiece)
pieceW.pu()
...
def drawPiece(col,row,color):
    ...
    xCoord = col * 40 + 80
    yCoord = row * 40 + 80
    piece.goto(xCoord+20,yCoord+20)
    pieceW.goto(xCoord+20,yCoord+20)
    global gameState
    if color == COLOR1:
        gameState[row][col] = 'B'
        piece.stamp()
